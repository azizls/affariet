...
public class annonceForm extends BaseForm{
    ...
    public annonceForm(Resources res ) {
        ...
        super("Annones",BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        current = this ;
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Lise des Annonces");
        ...
        RadioButton partage = RadioButton.createToggle("Annonces", barGroup);
       ...
       // bindButtonSelection(liste, arrow);
        ...
        ArrayList<annonce>list = AnnonceService.getInstance().getAllAnnonces();
        
        for(annonce rec : list ) {
        ...
        btnAjouter.addActionListener((e) -> { new addAnnonceForm(res).show();
        });
        add(btnAjouter);
    ...
    private void addButton(Image img,annonce rec , Resources res) {
        ...
        Label nTxt = new Label("type de l'annonce : "+rec.getType(),"NewsTopLine2" );
        Label empTxt = new Label("Description : "+rec.getDescription(),"NewsTopLine2" );
       ...
       ;
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cet annonce ?","Annuler","Oui")) {
                dig.dispose();
            }
            else {
                dig.dispose();
                ...
                if(AnnonceService.getInstance().deleteannonce(rec.getId_annonce())) {
