...
public class ListEvenementForm extends BaseForm{
    ...
    public ListEvenementForm(Resources res ) {
        ...
        ArrayList<Evenement>list = ServiceEvenement.getInstance().afficherEvenement();
        ...
        btnAjouter.addActionListener((e) -> { new AjouterEvenementForm(res).show();
        });
        add(btnAjouter);
    ...
    private void addButton(Image img,Evenement rec , Resources res) {
        ...
        Label nTxt = new Label("Nom de l evenement : "+rec.getNomEvent(),"NewsTopLine2" );
        Label empTxt = new Label("Emplacement : "+rec.getEmplacement(),"NewsTopLine2" );
        Label dTxt = new Label("Description : "+rec.getDescriptionEvent(),"NewsTopLine2" );
        Label pTxt = new Label("Prix : "+rec.getPrix(),"NewsTopLine2" );
        Label aTxt = new Label("Affiche : "+rec.getAffiche(),"NewsTopLine2" );
        Label nbrTxt = new Label("Nombre Maximal : "+rec.getNbrMax(),"NewsTopLine2" );
       ...
       ;
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cet evenement ?","Annuler","Oui")) {
                ...
                if(ServiceEvenement.getInstance().supprimerEvenement(rec.getIdEvent())) {
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(dTxt),
                BoxLayout.encloseX(pTxt),
                BoxLayout.encloseX(aTxt),
                BoxLayout.encloseX(nbrTxt),
