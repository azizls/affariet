...
public class addAnnonceForm extends BaseForm {
    ...
    // Display filtered or search results
        ...
        TextField type = new TextField("" , "entrez le type de l annonce !");
        type.setUIID("TextFieldBlack");
        addStringValue("type", type);
        
        
        
        TextField description = new TextField("" , "entrez la description!");
         ...
         btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(type.getText().equals("")|| description.getText().equals("")) {
                    ...
                    System.out.println("data  annonce == "+a);
                    //ServiceUtilisateur.getInstance().deleteUser(SessionManager.getId())
                    
                    //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base 
                    AnnonceService.getInstance().addAnnonce(a,SessionManager.getId());
                    
                    iDialog.dispose(); 
                    
                    ToastBar.Status status = ToastBar.getInstance().createStatus();
                    status.setMessage("annonce ajouté avec succès");
