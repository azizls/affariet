...
public class Produit {
   private int id_produit;
    ...
    public Produit(int id, String nom, String description, float prix, String image, int loggedInUser) {
    }
    ...
    public Produit(String nom_produit, String description_produit, float prix_produit, String image_produit, Categorie id_categorie) {
        this.nom_produit = nom_produit;
        this.description_produit = description_produit;
        this.prix_produit = prix_produit;
        this.image_produit = image_produit;
    ...
    public Produit(int id_produit, String nom_produit, String description_produit, float prix_produit, Categorie id_categorie, user user) {
        this.id_produit = id_produit;
        this.nom_produit = nom_produit;
        this.description_produit = description_produit;
        this.prix_produit = prix_produit;
    ...
    public Produit(int id_produit, String nom_produit, String description_produit, float prix_produit, Categorie id_categorie) {
        this.id_produit = id_produit;
        this.nom_produit = nom_produit;
        this.description_produit = description_produit;
        this.prix_produit = prix_produit;
